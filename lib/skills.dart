      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: Padding(
              padding: EdgeInsets.only(left: 25.0, bottom: 8.0, right: 16.0, top: 25.0), // Less padding
              child: Text(
                'Select your skills',
                style: TextStyle(
          ...
          Padding(
            ...
            child: Row(
              children: [
                buildLanguageButton('assets/images/baby.png', isBabySelected, 'baby'),
                  SizedBox(width: 40),
                buildLanguageButton('assets/images/bathroom.png', isBathroomSelected, 'bathroom'),
            ]
            ),
          ),
              SizedBox(height: 30,),
          Padding(
            ...
            child: Row(
                children: [
                  buildLanguageButton('assets/images/carwash.png', isCarWashSelected, 'carwash'),
                  SizedBox(width: 40),
                  buildLanguageButton('assets/images/cooking.png', isCookingSelected, 'cooking'),
                ]
            ),
          ),
          SizedBox(height: 30,),
          Padding(
            ...
            child: Row(
                children: [
                  buildLanguageButton('assets/images/elder.png', isElderSelected, 'elder'),
                  SizedBox(width: 40),
                  buildLanguageButton('assets/images/gardening.png', isGardeningSelected, 'garden'),
                ]
            ),
          ),
          SizedBox(height: 30,),
          Padding(
            ...
            child: Row(
                children: [
                  buildLanguageButton('assets/images/sweep.png', isSweepSelected, 'sweep'),
                  SizedBox(width: 40),
                  buildLanguageButton('assets/images/toilet.png', isToiletSelected, 'toilet'),
                ]
            ),
          ),
              ...
              child: Align(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const HousehelpHomepage()),
                    );
                  },
